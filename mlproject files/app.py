...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **Bhavna Shriwas**")
    st.markdown("🔗 GitHub: [Bhavna Shriwas](https://github.com/Bhavna851/Student-depression-predictor)")
    st.markdown("🔗 LinkedIn: [Profile](https://www.linkedin.com/in/bhavna-shriwas-31005132b)")
    st.markdown("---")
